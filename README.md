...
Welcome to SpectrumOS, a cutting-edge Linux distribution based on Arch Linux and powered by Qtile. SpectrumOS aims to revolutionize your desktop environment by seamlessly integrating the Dynamic Color Spectrum. With SpectrumOS, your system and Qtile themes dynamically adapt to the colors of your wallpaper, creating a visually stunning and immersive experience inspired by the vast color spectrum.
...
We understand the importance of productivity, which is why SpectrumOS offers a range of productivity-enhancing tools designed to boost your workflow. Our collection of rofi widgets, including a calculator, provide quick access to handy utilities. Additionally, SpectrumOS includes a built-in screen recorder powered by ffmpeg, enabling effortless screen capturing and sharing, so you can focus on your tasks without any interruptions.
